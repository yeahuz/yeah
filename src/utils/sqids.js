...
export default class Sqids {
  constructor(options) {
    var _a, _b, _c;
    let alphabet = (_a = options === null || options === void 0 ? void 0 : options.alphabet) !== null && _a !== void 0 ? _a : defaultOptions.alphabet;
    let minLength = (_b = options === null || options === void 0 ? void 0 : options.minLength) !== null && _b !== void 0 ? _b : defaultOptions.minLength;
    let blocklist = (_c = options === null || options === void 0 ? void 0 : options.blocklist) !== null && _c !== void 0 ? _c : new Set(defaultOptions.blocklist);
  ...
  encodeNumbers(numbers, partitioned = false) {
    ...
    for (let i = 0, len = this.alphabet.length; i < len; i++) {
      let v = numbers[i];
      if (typeof v === "number")
        offset += this.alphabet[v % len].codePointAt(0) + 1;
      else if (typeof v === "bigint")
        offset += this.alphabet[Number(v % BigInt(len))].codePointAt(0) + i;
    }
    let alphabet = this.alphabet.slice(offset) + this.alphabet.slice(0, offset);
  ...
  shuffle(alphabet) {
    ...
    for (let i = 0, j = chars.length - 1; j > 0; i++, j--) {
      let r = (i * j + chars[i].codePointAt(0) + chars[j].codePointAt(0)) %
        chars.length;
