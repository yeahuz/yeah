...
export const configs = {
  production: {
    ...
    ws_uri_internal: WS_URI_INTERNAL,
    ws_uri_public: WS_URI_PUBLIC,
  ...
  development: {
    ...
    es_password: ES_PASSWORD,
    origin: ORIGIN_DEV,
    origin_cors: ORIGIN_DEV_CORS,
    jwt_secret: JWT_SECRET,
    ws_uri_internal: WS_URI_INTERNAL_DEV,
    ws_uri_public: WS_URI_PUBLIC_DEV,
    sms_api_uri: SMS_API_URI,
    sms_api_email: SMS_API_EMAIL,
    sms_api_password: SMS_API_PASSWORD,
    sms_api_token: SMS_API_TOKEN,
  ...
  staging: {
    ...
    google_maps_api_key: GOOGLE_MAPS_API_KEY,
    google_js_maps_api_key: GOOGLE_JS_MAPS_API_KEY,
    google_oauth_redirect_uri: GOOGLE_OAUTH_REDIRECT_URI_STAGING,
    telegram_bot_token: TELEGRAM_BOT_TOKEN,
    node_env: NODE_ENV,
    rp_id: RP_ID_STAGING,
    rp_name: RP_NAME,
    ...
    origin_cors: ORIGIN_STAGING_CORS,
    jwt_secret: JWT_SECRET,
    ws_uri_internal: WS_URI_INTERNAL_STAGING,
    ws_uri_public: WS_URI_PUBLIC_STAGING,
    sms_api_uri: SMS_API_URI,
    sms_api_email: SMS_API_EMAIL,
    sms_api_password: SMS_API_PASSWORD,
    sms_api_token: SMS_API_TOKEN,
    ...
    octo_api_uri: OCTO_API_URI,
    octo_merchant_id: OCTO_MERCHANT_ID,
    octo_redirect_uri: OCTO_REDIRECT_URI_STAGING,
  },
};
